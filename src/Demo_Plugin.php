...
class Demo_Plugin {
	...
	private function define_acf_hooks(): void {
		...
		$acf_hooks = new ACF_Hooks();

		$this->loader->add_filter( 'acf/settings/save_json', $acf_hooks, 'acf_json_save_point' );
		$this->loader->add_filter( 'acf/settings/load_json', $acf_hooks, 'acf_json_load_point' );
	}
